            ...
            <div class="col-xl-7 col-lg-6 col-md-6 d-flex flex-column mx-auto">
              <div class="card card-plain mt-8">
                ...
                <div class="card-header pb-0 text-center bg-transparent">
                  ...
                  <div class="row mb-4">
                    <div class="col-12">
                      <img src="{{ url('/storage/images/logo.png') }}" class="img img-fluid" style="width: 150px;">
                    </div>
                  </div>

                  <h3 class="font-weight-bolder text-info text-gradient" style="background-image: linear-gradient(310deg, #21aeb5, #007177); font-size:25px">
                    Bem-Vindo
                  </h3>
                  <p class="mb-0">Faça o login para acessar a plataforma</p>
                </div>
                ...
                <div class="card-footer text-center pt-0 px-lg-2 px-1">
                  ...
                  <p class="mb-2 text-sm mx-auto">
                    Não possui conta?
                    <a href="#" class="text-info text-gradient font-weight-bold">Registre-se agora.</a>
                  </p> 
                  
                   <p class="mb-4 text-sm mx-auto">
                    <a href="#" class="text-info font-weight-bold">Esqueceu sua senha?</a>
                  </p> 
                </div>
